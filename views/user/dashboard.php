...
$userStats = $queries->getUserStats($_SESSION['user_id']);
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-3 gap-6 mb-8">
                    <div class="dashboard-card p-6 rounded-xl text-white">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold"><?php echo $userStats['total_pengajuan']; ?></h3>
                            </div>
                    ...
                    <div class="dashboard-card p-6 rounded-xl text-white">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-gray-300">Menunggu</p>
                                <h3 class="text-3xl font-bold"><?php echo $userStats['menunggu']; ?></h3>
                            </div>
                    ...
                    <div class="dashboard-card p-6 rounded-xl text-white">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-gray-300">Disetujui</p>
                                <h3 class="text-3xl font-bold"><?php echo $userStats['disetujui']; ?></h3>
                            </div>
                ...
                <div class="dashboard-card rounded-xl p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-xl font-semibold text-white">Event Terbaru</h3>
                        <a href="index.php?action=my_events" class="text-blue-400 hover:text-blue-300">

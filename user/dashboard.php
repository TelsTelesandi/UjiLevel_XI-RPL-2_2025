...
<main>
    <section class="dashboard-section">
        <h2><i class="fas fa-user-circle" style="color:#2563eb"></i> Selamat datang, <?php echo $_SESSION['nama_lengkap']; ?></h2>
        <div class="user-stats">
            <div class="stat-card">
                <h3><i class="fas fa-calendar-plus"></i> Total Event Diajukan</h3>
                <?php
            ...
            <div class="stat-card">
                <h3><i class="fas fa-check-circle"></i> Event Disetujui</h3>
                <?php
            ...
            <div class="stat-card">
                <h3><i class="fas fa-times-circle"></i> Event Ditolak</h3>
                <?php
        ...
        <div class="quick-actions">
            <a href="event_form.php" class="btn btn-primary"><i class="fas fa-plus"></i> Ajukan Event Baru</a>
            <a href="my_events.php" class="btn btn-secondary"><i class="fas fa-list"></i> Lihat Event Saya</a>
        </div>
        <div class="recent-events">
            <h3><i class="fas fa-history"></i> Event Terakhir Anda</h3>
            <?php

...
$stats_query = "SELECT 
    ...
    FROM event_pengajuan WHERE user_id = ?";
$stats_stmt = $db->prepare($stats_query);
$stats_stmt->execute([$user_id]);
$stats = $stats_stmt->fetch(PDO::FETCH_ASSOC);

// Get recent submissions
$recent_query = "SELECT * FROM event_pengajuan WHERE user_id = ? ORDER BY tanggal_pengajuan DESC LIMIT 5";
...
<head>
    ...
    <title>Dashboard User - Event Manager</title>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link text-white active" href="user_dashboard.php">
